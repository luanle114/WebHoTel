...
<div class="container room-title">
		...
		<div id="myCarousel" class="carousel slide border" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active" role="listbox">
					<img class="d-block w-100" src="../New folder/images/2bed.jpg" alt="firstslide">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="../New folder/images/2bed1.jpg" alt="secondslide">
				</div>
				<div class="carousel-item">
	...
	<div class="col-md-5 col-sm-5">
		<div class="room-details-text">
			<h3 class="room-details-title" style="font-family: Bodoni MT"> Phòng Deluxe 2 giường đơn </h3>
			<p><b>Kích thước :</b> 42m<sup>2</sup></p>
			<p>Phòng 2 giường đơn này có ban công, máy điều hòa, ghế sofa và phòng tắm riêng.</p>
