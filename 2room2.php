	...
	<div class="row">
		...
		<div class="col-md-5 col-sm-5">
			...
			<div class="room-details-text">
				...
				<h3 class="room-details-title" style="font-family: Bodoni MT"> Biệt thự 2 phòng ngủ </h3>
				<p><b>Kích thước :</b> 190m<sup>2</sup></p>
				<p>Biệt thự có hồ bơi riêng, điều hòa toàn biệt thự, 2 phòng ngủ, phòng khách, phòng bếp, 2 phòng tắm và 3 WC.</p>
				<p>Giá được áp dụng cho 4 người lớn, bao bữa sáng. Biệt thự có thể chứa được tối đa 4 người lớn kèm 4 trẻ em và không thể chứa giường phụ.</p>
			...
			<div class="col-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="phong1bed2.php" id="chitietphong" class="btn btn-success" style="margin-top: 70px">Xem chi tiết phòng</a>
					</div>
				</div>
			</div>
