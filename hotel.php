			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="../New folder/phong1bed.php" id="chitietphong" class="btn btn-success">Xem chi tiết</a>
					</div>
				</div>
			</div>
			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="../New folder/phong2bed.php" id="chitietphong" class="btn btn-success">Xem chi tiết</a>
					</div>
				</div>
			</div>	
		</div>
			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="2room.php" id="chitietphong" class="btn btn-success">Xem chi tiết</a>
					</div>
				</div>
			</div>
			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="3room.php" id="chitietphong" class="btn btn-success">Xem chi tiết</a>
					</div>
				</div>
			</div>	
		</div>
